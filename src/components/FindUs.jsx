  ...
  return (
    <div>
      ...
      <div className="text-[#706f6f] font-[500] *:w-full text-[17px]">
        <button className="flex items-center gap-3 border-1 border-[#e7e7e7]  p-4 rounded-t-[4px] cursor-pointer">
        ...
        <button className="flex items-center gap-3 border-1 border-[#e7e7e7]  p-4 border-t-0 cursor-pointer rounded-b-[4px]">
